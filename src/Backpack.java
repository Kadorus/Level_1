public class Backpack {
	...
	public static void main (String[] args){
		...
		Backpack thePack = new Backpack();
		
		Supply ppencil = new Pencil();
		
		Supply rruler = new Ruler();
		
		Supply ttextbook = new Textbook();
		
		thePack.putInBackpack(ppencil);
		thePack.putInBackpack(rruler);
		thePack.putInBackpack(ttextbook);
